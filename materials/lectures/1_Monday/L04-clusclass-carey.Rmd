...
library(png)
im = readPNG("figures/smallcyc.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/spellLinks.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/barcoTree.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/snyderPC12.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/toolpic.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/metricDef.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/jaccdef.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/bootstrap1.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/bootstrap2.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/bootstrap3.png")
grid.raster(im)
```
...
library(png)
im = readPNG("figures/fullcyc.png")
grid.raster(im)
```
