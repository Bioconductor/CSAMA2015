...
- 4-parameter regression has capacity to identify various oscillatory patterns
- $F$ statistic is large for oscillating genes
- We can obtain a set of oscillators by thresholding $F$ or considering statistical significance
- Are there clusters among the oscillators?
