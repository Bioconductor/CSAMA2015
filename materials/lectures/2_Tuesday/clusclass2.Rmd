...
```{r basicbarco,fig=TRUE,echo=FALSE,fig.height=3.9}
library(png)
...
```{r wardalg,fig=TRUE,echo=FALSE,fig.height=4.99}
library(png)
im = readPNG("wards.png")
grid.raster(im)
```
...
- yeast cell cycle 
    - compute distance to an interpretable exemplar
