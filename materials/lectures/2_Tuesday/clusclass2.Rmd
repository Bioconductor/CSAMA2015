...
- Roles of clustering and classification procedures
    - Clustering: establishes a modular structure in the data
         - explanation through contrast, divide and conquer
    - Classification: module labels and assignments given _a priori_
         - with features $x$ and labels $y$, can we discover $f$ satisfying $y = f(x)$?

## Yeast cell cycle schematic

```{r basicycc,fig=TRUE,echo=FALSE,fig.height=5.2}
library(png)
...
```{r regmod,fig=TRUE,echo=FALSE,fig.height=5.2}
library(png)
